#include <stdio.h>
#include <stdlib.h>
void sort_Descending(int items[], int n)
{
    int i, j, temp;
    for(i = 0; i < n - 1; i++) {
        for(j = i + 1; j < n; j++) {
...
int first_fit(int items[], int n, int capacity)
{
    int res = 0;
    int bin_rem[n];
    int i, j;
...
int best_fit(int items[], int n, int capacity)
{
    int res = 0;
    int bin_rem[n];
    int i, j;
...
int main()
{
    ...
    printf("First Fit: %d bins\n", first_fit(items, n, capacity));
    printf("Best Fit: %d bins\n", best_fit(items, n, capacity));
    sort_Descending(items, n);
